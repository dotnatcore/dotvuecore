...
namespace DotVueCore.Data.Models
{
    ...
    public partial class DotVueCoreContext : DbContext
    {

        public DotVueCoreContext() :
            base()
        {
            OnCreated();
        }

        public DotVueCoreContext(DbContextOptions<DotVueCoreContext> options) :
            base(options)
        {
            OnCreated();
        }
        ...
        {
            //optionsBuilder.UseSqlServer(@"Data Source=podiumdbserver.database.windows.net;Initial Catalog=PodiumUAT;Integrated Security=False;Persist Security Info=True;User ID=podium;Password=123@gjinfo");
        ...
        public virtual DbSet<ActivityLogTypePermission> ActivityLogTypePermissions
        {
            get;
            set;
        }
        ...
        public virtual DbSet<RtoOrganizationUser> RtoOrganizationUsers
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.ActivityLogTypePermissionMapping(modelBuilder);
            this.CustomizeActivityLogTypePermissionMapping(modelBuilder);
            ...
            this.RtoOrganizationUserMapping(modelBuilder);
            this.CustomizeRtoOrganizationUserMapping(modelBuilder);
        ...
        #region ActivityLogTypePermission Mapping

        private void ActivityLogTypePermissionMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ActivityLogTypePermission>().ToTable(@"ActivityLogTypePermissions", @"dbo");
            modelBuilder.Entity<ActivityLogTypePermission>().Property<long>(x => x.ActivityLogTypePermissionId).HasColumnName(@"ActivityLogTypePermissionId").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<long>(x => x.ActivityTypeId).HasColumnName(@"ActivityTypeId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<long>(x => x.RoleId).HasColumnName(@"RoleId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<bool>(x => x.Permission).HasColumnName(@"Permission").HasColumnType(@"bit").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<long>>(x => x.FilterId).HasColumnName(@"FilterId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<int>>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").ValueGeneratedNever().HasDefaultValueSql(@"1");
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<long>>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<System.DateTime>>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<long>>(x => x.LastModifiedBy).HasColumnName(@"LastModifiedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<System.DateTime>>(x => x.ModifiedDate).HasColumnName(@"ModifiedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<long>>(x => x.DeletedBy).HasColumnName(@"DeletedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().Property<System.Nullable<System.DateTime>>(x => x.DeletedDate).HasColumnName(@"DeletedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<ActivityLogTypePermission>().HasKey(@"ActivityLogTypePermissionId");
        }
	
        partial void CustomizeActivityLogTypePermissionMapping(ModelBuilder modelBuilder);
        ...
        {
            modelBuilder.Entity<AspnetRole>().ToTable(@"AspnetRole", @"dbo");
            modelBuilder.Entity<AspnetRole>().Property<long>(x => x.Id).HasColumnName(@"Id").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AspnetRole>().Property<string>(x => x.Name).HasColumnName(@"Name").HasColumnType(@"nvarchar(max)").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<string>(x => x.Description).HasColumnName(@"Description").HasColumnType(@"nvarchar(300)").ValueGeneratedNever().HasMaxLength(300);
            modelBuilder.Entity<AspnetRole>().Property<int>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<long>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<System.DateTime>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<System.Nullable<long>>(x => x.LastModifiedBy).HasColumnName(@"LastModifiedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<System.Nullable<System.DateTime>>(x => x.ModifiedDate).HasColumnName(@"ModifiedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<System.Nullable<long>>(x => x.DeletedBy).HasColumnName(@"DeletedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetRole>().Property<System.Nullable<System.DateTime>>(x => x.DeletedDate).HasColumnName(@"DeletedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
        ...
        {
            modelBuilder.Entity<AspnetUserLogin>().ToTable(@"AspnetUserLogins", @"dbo");
            modelBuilder.Entity<AspnetUserLogin>().Property<long>(x => x.UserLoginId).HasColumnName(@"UserLoginId").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AspnetUserLogin>().Property<long>(x => x.UserId).HasColumnName(@"UserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<string>(x => x.LoginProvider).HasColumnName(@"LoginProvider").HasColumnType(@"nvarchar(128)").IsRequired().ValueGeneratedNever().HasMaxLength(128);
            modelBuilder.Entity<AspnetUserLogin>().Property<string>(x => x.ProviderKey).HasColumnName(@"ProviderKey").HasColumnType(@"nvarchar(128)").IsRequired().ValueGeneratedNever().HasMaxLength(128);
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<int>>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<long>>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<System.DateTime>>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<long>>(x => x.LastModifiedBy).HasColumnName(@"LastModifiedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<System.DateTime>>(x => x.ModifiedDate).HasColumnName(@"ModifiedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<long>>(x => x.DeletedBy).HasColumnName(@"DeletedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().Property<System.Nullable<System.DateTime>>(x => x.DeletedDate).HasColumnName(@"DeletedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserLogin>().HasKey(@"UserLoginId");
        }
        ...
        {
            modelBuilder.Entity<AspnetUserRole>().ToTable(@"AspnetUserRole", @"dbo");
            modelBuilder.Entity<AspnetUserRole>().Property<long>(x => x.UserId).HasColumnName(@"UserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<long>(x => x.RoleId).HasColumnName(@"RoleId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<long>(x => x.UserRoleId).HasColumnName(@"UserRoleId").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<int>>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<long>>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<System.DateTime>>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<long>>(x => x.LastModifiedBy).HasColumnName(@"LastModifiedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<System.DateTime>>(x => x.ModifiedDate).HasColumnName(@"ModifiedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<long>>(x => x.DeletedBy).HasColumnName(@"DeletedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().Property<System.Nullable<System.DateTime>>(x => x.DeletedDate).HasColumnName(@"DeletedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<AspnetUserRole>().HasKey(@"UserRoleId");
        }
        ...
        private void OrganizationUserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrganizationUser>().Property<long>(x => x.UserId).HasColumnName(@"UserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<OrganizationUser>().Property<long>(x => x.OrganizationId).HasColumnName(@"OrganizationId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<OrganizationUser>().Property<System.Nullable<long>>(x => x.RoleId).HasColumnName(@"RoleId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<OrganizationUser>().Property<System.Nullable<System.DateTime>>(x => x.StudentRegistrationInfoSentDate).HasColumnName(@"StudentRegistrationInfoSentDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<OrganizationUser>().Property<bool>(x => x.IsDefault).HasColumnName(@"IsDefault").HasColumnType(@"bit").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<OrganizationUser>().Property<System.Nullable<System.DateTime>>(x => x.LastLoginDate).HasColumnName(@"LastLoginDate").HasColumnType(@"datetime2").ValueGeneratedNever();
        ...
        private void RoleMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().Property<long>(x => x.RoleId).HasColumnName(@"RoleId").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<Role>().Property<string>(x => x.RoleName).HasColumnName(@"RoleName").HasColumnType(@"nvarchar(250)").ValueGeneratedNever().HasMaxLength(250);
            modelBuilder.Entity<Role>().Property<System.Nullable<int>>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").ValueGeneratedNever().HasDefaultValueSql(@"1");
            modelBuilder.Entity<Role>().Property<System.Nullable<long>>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<Role>().Property<System.Nullable<System.DateTime>>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
        ...
        #region RtoOrganizationUser Mapping

        private void RtoOrganizationUserMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RtoOrganizationUser>().ToTable(@"RtoOrganizationUsers", @"dbo");
            modelBuilder.Entity<RtoOrganizationUser>().Property<long>(x => x.RtoOrganizationUserId).HasColumnName(@"RtoOrganizationUserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<RtoOrganizationUser>().Property<long>(x => x.OrganizationUserId).HasColumnName(@"OrganizationUserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.OrganizationId).HasColumnName(@"OrganizationId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<long>(x => x.RtoId).HasColumnName(@"RtoId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.UserId).HasColumnName(@"UserId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.RtoOrganizationId).HasColumnName(@"RtoOrganizationId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<bool>>(x => x.IsDownloadMoa).HasColumnName(@"IsDownloadMoa").HasColumnType(@"bit").ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<bool>>(x => x.IsShowStartUp).HasColumnName(@"IsShowStartUp").HasColumnType(@"bit").ValueGeneratedNever().HasDefaultValueSql(@"1");
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<bool>>(x => x.IsAcceptTerm).HasColumnName(@"IsAcceptTerm").HasColumnType(@"bit").ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<bool>>(x => x.IsDoneInduction).HasColumnName(@"IsDoneInduction").HasColumnType(@"bit").ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<int>>(x => x.Mode).HasColumnName(@"Mode").HasColumnType(@"int").ValueGeneratedNever().HasDefaultValueSql(@"1");
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.CreatedBy).HasColumnName(@"CreatedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<System.DateTime>>(x => x.CreatedDate).HasColumnName(@"CreatedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.LastModifiedBy).HasColumnName(@"LastModifiedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<System.DateTime>>(x => x.ModifiedDate).HasColumnName(@"ModifiedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<long>>(x => x.DeletedBy).HasColumnName(@"DeletedBy").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().Property<System.Nullable<System.DateTime>>(x => x.DeletedDate).HasColumnName(@"DeletedDate").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<RtoOrganizationUser>().HasKey(@"RtoOrganizationUserId");
        }
	
        partial void CustomizeRtoOrganizationUserMapping(ModelBuilder modelBuilder);
        ...
        private void RtoUserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RtoUser>().Property<long>(x => x.RtoId).HasColumnName(@"RtoId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<RtoUser>().Property<long>(x => x.UserId).HasColumnName(@"UserId").HasColumnType(@"bigint").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<RtoUser>().Property<System.Nullable<long>>(x => x.RoleId).HasColumnName(@"RoleId").HasColumnType(@"bigint").ValueGeneratedNever();
            modelBuilder.Entity<RtoUser>().Property<bool>(x => x.IsDefault).HasColumnName(@"IsDefault").HasColumnType(@"bit").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<RtoUser>().Property<System.Nullable<System.DateTime>>(x => x.LastLoginDate).HasColumnName(@"LastLoginDate").HasColumnType(@"datetime2").ValueGeneratedNever();
        ...
        private void UserMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().Property<bool>(x => x.IsPodiumAdmin).HasColumnName(@"IsPodiumAdmin").HasColumnType(@"bit").IsRequired().ValueGeneratedNever();
        ...
        #region ActivityLogTypePermission Navigation properties

            modelBuilder.Entity<ActivityLogTypePermission>().HasOne(x => x.ActivityType).WithMany(op => op.ActivityLogTypePermissions).IsRequired(true).HasForeignKey(@"ActivityTypeId");
            modelBuilder.Entity<ActivityLogTypePermission>().HasOne(x => x.Role).WithMany(op => op.ActivityLogTypePermissions).IsRequired(true).HasForeignKey(@"RoleId");
        ...
        #region ActivityType Navigation properties
            ...
            modelBuilder.Entity<ActivityType>().HasMany(x => x.ActivityLogTypePermissions).WithOne(op => op.ActivityType).IsRequired(true).HasForeignKey(@"ActivityTypeId");
        ...
        #region AspnetRole Navigation properties

            modelBuilder.Entity<AspnetRole>().HasMany(x => x.AspnetUserRoles).WithOne(op => op.AspnetRole).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"RoleId");

        #endregion

        #region AspnetUserLogin Navigation properties

            modelBuilder.Entity<AspnetUserLogin>().HasOne(x => x.User).WithMany(op => op.AspnetUserLogins).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"UserId");

        #endregion

        #region AspnetUserRole Navigation properties

            modelBuilder.Entity<AspnetUserRole>().HasOne(x => x.User).WithMany(op => op.AspnetUserRoles).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"UserId");
            modelBuilder.Entity<AspnetUserRole>().HasOne(x => x.AspnetRole).WithMany(op => op.AspnetUserRoles).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"RoleId");
        ...
        #region Organization Navigation properties
            ...
            modelBuilder.Entity<Organization>().HasMany(x => x.OrganizationUsers).WithOne(op => op.Organization).IsRequired(true).HasForeignKey(@"OrganizationId");
            ...
            modelBuilder.Entity<Organization>().HasMany(x => x.RtoOrganizationUsers).WithOne(op => op.Organization).HasForeignKey(@"OrganizationId");
        ...
        #region OrganizationUser Navigation properties
            ...
            modelBuilder.Entity<OrganizationUser>().HasOne(x => x.Organization).WithMany(op => op.OrganizationUsers).IsRequired(true).HasForeignKey(@"OrganizationId");
            modelBuilder.Entity<OrganizationUser>().HasOne(x => x.User).WithMany(op => op.OrganizationUsers).IsRequired(true).HasForeignKey(@"UserId");
            modelBuilder.Entity<OrganizationUser>().HasOne(x => x.Role).WithMany(op => op.OrganizationUsers).HasForeignKey(@"RoleId");
            modelBuilder.Entity<OrganizationUser>().HasMany(x => x.RtoOrganizationUsers).WithOne(op => op.OrganizationUser).IsRequired(true).HasForeignKey(@"OrganizationUserId");
        ...
        #region Role Navigation properties
            ...
            modelBuilder.Entity<Role>().HasMany(x => x.ActivityLogTypePermissions).WithOne(op => op.Role).IsRequired(true).HasForeignKey(@"RoleId");
            modelBuilder.Entity<Role>().HasMany(x => x.OrganizationUsers).WithOne(op => op.Role).HasForeignKey(@"RoleId");
            modelBuilder.Entity<Role>().HasMany(x => x.RtoUsers).WithOne(op => op.Role).IsRequired(true).HasForeignKey(@"RtoId");
        ...
        #region RtoInfo Navigation properties
            ...
            modelBuilder.Entity<RtoInfo>().HasMany(x => x.RtoOrganizationUsers).WithOne(op => op.RtoInfo).IsRequired(true).HasForeignKey(@"RtoId");
            modelBuilder.Entity<RtoInfo>().HasMany(x => x.RtoUsers).WithOne(op => op.RtoInfo).IsRequired(true).HasForeignKey(@"RtoId");
        ...
        #region RtoOrganization Navigation properties
            ...
            modelBuilder.Entity<RtoOrganization>().HasMany(x => x.RtoOrganizationUsers).WithOne(op => op.RtoOrganization).HasForeignKey(@"RtoOrganizationId");

        #endregion

        #region RtoOrganizationUser Navigation properties

            modelBuilder.Entity<RtoOrganizationUser>().HasOne(x => x.OrganizationUser).WithMany(op => op.RtoOrganizationUsers).IsRequired(true).HasForeignKey(@"OrganizationUserId");
            modelBuilder.Entity<RtoOrganizationUser>().HasOne(x => x.RtoInfo).WithMany(op => op.RtoOrganizationUsers).IsRequired(true).HasForeignKey(@"RtoId");
            modelBuilder.Entity<RtoOrganizationUser>().HasOne(x => x.RtoOrganization).WithMany(op => op.RtoOrganizationUsers).HasForeignKey(@"RtoOrganizationId");
            modelBuilder.Entity<RtoOrganizationUser>().HasOne(x => x.User).WithMany(op => op.RtoOrganizationUsers).HasForeignKey(@"UserId");
            modelBuilder.Entity<RtoOrganizationUser>().HasOne(x => x.Organization).WithMany(op => op.RtoOrganizationUsers).HasForeignKey(@"OrganizationId");

        #endregion

        #region RtoUser Navigation properties

            modelBuilder.Entity<RtoUser>().HasOne(x => x.RtoInfo).WithMany(op => op.RtoUsers).IsRequired(true).HasForeignKey(@"RtoId");
            modelBuilder.Entity<RtoUser>().HasOne(x => x.Role).WithMany(op => op.RtoUsers).IsRequired(true).HasForeignKey(@"RtoId");
            modelBuilder.Entity<RtoUser>().HasOne(x => x.User).WithMany(op => op.RtoUsers).IsRequired(true).HasForeignKey(@"UserId");
        ...
        #region User Navigation properties
            ...
            modelBuilder.Entity<User>().HasMany(x => x.AspnetUserLogins).WithOne(op => op.User).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"UserId");
            modelBuilder.Entity<User>().HasMany(x => x.AspnetUserRoles).WithOne(op => op.User).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"UserId");
            ...
            modelBuilder.Entity<User>().HasMany(x => x.OrganizationUsers).WithOne(op => op.User).IsRequired(true).HasForeignKey(@"UserId");
            modelBuilder.Entity<User>().HasMany(x => x.RtoOrganizationUsers).WithOne(op => op.User).HasForeignKey(@"UserId");
            modelBuilder.Entity<User>().HasMany(x => x.RtoUsers).WithOne(op => op.User).IsRequired(true).HasForeignKey(@"UserId");
