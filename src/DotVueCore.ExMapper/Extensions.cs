...
namespace DotVueCore.ExMapper
{
    public static class Extensions
    {
        ...
        public static void MapTypes(this Assembly assembly, IMapperConfigurationExpression mapperConfiguration)
        {
            ...
            var mappedTypes = 
                assemblyTypes.Select(type => new
                {
                    Type = type,
                    MapsToAttributes = type.GetTypeInfo().GetCustomAttributes(typeof(MapsToAttribute), true).Cast<MapsToAttribute>(),
                    MapsFromAttributes = type.GetTypeInfo().GetCustomAttributes(typeof(MapsFromAttribute), true).Cast<MapsFromAttribute>()
                })
